...
static int const GAME_RUNTIME_TASK_GAME_CONFIG_ERROR = 0;
static int const GAME_RUNTIME_TASK_PLUGIN_ERROR = 1;

@protocol GameRuntimeTaskListener <NSObject>
...
@protocol GameRuntimeTask <NSObject>
