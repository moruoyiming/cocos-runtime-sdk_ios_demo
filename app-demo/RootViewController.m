...
- (void)viewDidLoad {
    ...
    NavigationViewController *hallNav = [[NavigationViewController alloc] initWithRootViewController:hallVC];
    [hallVC setTitle:@"大厅"];
    [hallVC.tabBarItem setImage:[UIImage imageNamed:@"hall_unclick_icon"]];
    [hallVC.tabBarItem setSelectedImage:[UIImage imageNamed:@"hall_click_icon"]];
    [self addChildViewController:hallNav];
    
//    UIViewController *pvpVC = [[UIViewController alloc] init];
//    NavigationViewController *pvpNav = [[NavigationViewController alloc] initWithRootViewController:pvpVC];
//    [pvpVC.view setBackgroundColor:[UIColor greenColor]];
//    [pvpVC setTitle:@"对战"];
//    [self addChildViewController:pvpNav];
    
    AccountViewController *userVC = [[AccountViewController alloc] init];
    NavigationViewController *userNav = [[NavigationViewController alloc] initWithRootViewController:userVC];
    [userVC setTitle:@"用户"];
    [userVC.tabBarItem setImage:[UIImage imageNamed:@"user_unclick_icon"]];
    [userVC.tabBarItem setSelectedImage:[UIImage imageNamed:@"user_click_icon"]];
