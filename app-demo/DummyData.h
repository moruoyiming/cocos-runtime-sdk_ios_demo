...
static NSString *KEY_APP_ID = @"app_id";
static NSString *KEY_ICON = @"icon";
static NSString *KEY_HASH = @"hash";
static NSString *KEY_NAME = @"name";
static NSString *KEY_ORIENTATION = @"orientation";
static NSString *KEY_SCREEN_MODE = @"screen_mode";
static NSString *KEY_TAG = @"tags";
static NSString *KEY_URL = @"url";
static NSString *KEY_VERSION = @"version";
static NSString *KEY_REQUIRE = @"require";
...
@property (nonatomic, copy) NSArray *require;
