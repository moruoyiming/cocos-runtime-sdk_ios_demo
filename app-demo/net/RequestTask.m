...
@property (nonatomic, copy) OnRequestComplete complete;
@end

@implementation RequestTask

- (instancetype)initWithComplete:(OnRequestComplete)complete
{
    self = [super init];
    if (self) {
        _complete = complete;
...
- (void)_onComplete:(NSString *)data {
